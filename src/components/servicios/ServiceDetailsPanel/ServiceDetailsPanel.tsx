import type { ServiceDetailsVariant } from '@/content/data/servicios';
...
export function ServiceDetailsPanel({ title, items, variant }: ServiceDetailsPanelProps) {
  const List = variant === 'steps' ? 'ol' : 'ul';

  return (
    <div className={[styles.panel, styles[variant]].join(' ')}>
