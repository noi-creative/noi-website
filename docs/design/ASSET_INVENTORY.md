...
| `pages/nosotras/section-devolver-1.jpg` (658×840) | `nosotras.sectionDevolver[0]` | ✓           | TODO ALT                               | "Devolver lo humano" section, the photo of three women.                                                                                                                                             |
| `pages/nosotras/section-devolver-2.png` (894×778) | `nosotras.sectionDevolver[1]` | ✓           | TODO ALT                               | "Devolver lo humano" section, possibly an alternate crop or the small lightbulb area.                                                                                                               |
| `pages/nosotras/team-portrait-1.jpg` (657×840)    | `nosotras.teamPortraits[0]`   | ✓           | "Daniela — Founder & Brand Strategist" | Daniela card.                                                                                                                                                                                       |
| `pages/nosotras/team-portrait-2.jpg` (658×840)    | `nosotras.teamPortraits[1]`   | ✓           | "María Patricia — Creative Director"   | María Patricia card.                                                                                                                                                                                |
| (none)                                            | `nosotras.teamPortraits[2]`   | **Missing** | n/a                                    | Carla (Brand & Project Coordinator) portrait. **TODO**: P02 must source the asset.                                                                                                                  |
...
| `nosotras.teamPortraits[2]` is `null`                                                                                                      | Carla portrait missing                                 | **P02** (Nosotras). Source the asset.                                                                                                             |
...
- P02 will resolve the `nosotras.teamPortraits[2]` gap and confirm or promote the team illustration.
